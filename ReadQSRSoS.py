...
def find_entry(qsr_data, saletime, check_name):
    for d in qsr_data.values():
        ...
        new_sec = int(d['entered'][-2:]) - 1 # CHANGED 11/16/25
        if new_sec < 0:
            new_sec = 59
            new_min -= 1
            if new_min < 0:
...
def get_QSR_data():
    ...
    with open('C:/Users/Squirrel/Desktop/SOS20251206.txt', 'r', encoding="utf-16") as qsr_file:
    ...
    # with open('c:/ProgramData/QSR Automations/ConnectSmart/BackOffice/SpeedofService/SOS20251205.txt', 'r', encoding="utf-16") as qsr_file:
