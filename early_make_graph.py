...
def make_daily_prod(wbook, prods, sheet_name, graph_name, legend_name, ylimit=40, smooth_it=False):
...
#    WS = WORKBOOK[time.strftime('%m_%d_%Y')]
    ...
    hr_start = 9 # Changed for 9am start #
    hr_end = 9 # Changed for 9am start #
    min_start = 0
